   ...
   return (
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className='input-group'>
         ...
         {/* 재고 입력 필드 */}
         <div className="input-section item-amount">
            <p>재고/수량</p>
         ...
         <div className="input-section">
            <p>상품 설명</p>
           <textarea className='item-create-input' label="상품설명"  placeholder='상품설명을 작성해주세요.' value={itemDetail} onChange={(e) => setItemDetail(e.target.value)}  />
          </div>
